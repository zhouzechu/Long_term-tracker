...
VID_root = 'E:/ILSVRC2015_VID_new/ILSVRC2015/'
save_dir = 'E:/train_Skim/type_video'
if not os.path.exists(save_dir):
    os.mkdir(save_dir)
if __name__ == '__main__':
    VID_anno_root = os.path.join(VID_root, 'Annotations/VID/train')
    folders = ['ILSVRC2015_VID_train_0000', 'ILSVRC2015_VID_train_0001', 'ILSVRC2015_VID_train_0002', 'ILSVRC2015_VID_train_0003']  # ILSVRC2015训练文件夹
    types = ['n02691156','n02419796','n02131653','n02834778','n01503061',
             ...
             'n04468005','n01662784','n04530566','n02062744','n02391049']  # 与下面30个类名相对应
